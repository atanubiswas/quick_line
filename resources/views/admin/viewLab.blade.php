                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" data-id="{{$labratorye->id}}" class="btn view_documents_btn btn-block bg-gradient-purple btn-xs"><i class="fas fa-id-card"></i> View Documents</button>
